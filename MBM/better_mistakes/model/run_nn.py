...
from MBM.better_mistakes.model.performance import accuracy_from_wordvecs
from MBM.better_mistakes.model.run_xent import _update_tb_from_summary, _make_best_hier_similarities
...
def run_nn(loader, model, loss_function, distances, classes, opts, epoch, prev_steps, embedding_layer, word2vec_mat, optimizer=None, is_inference=True):
    ...
    with conditional(is_inference, torch.no_grad()):
        ...
        print(get_metrics(softmax_output, test_target, distances, classes))
